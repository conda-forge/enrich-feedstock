...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/enrich-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11664&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/enrich-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `enrich` can be installed with:

```
conda install enrich
```

It is possible to list all of the versions of `enrich` available on your platform with:
